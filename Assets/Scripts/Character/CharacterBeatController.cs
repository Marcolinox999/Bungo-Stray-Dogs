...
public class CharacterBeatController : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 100f)] protected float m_maxAcceleration = 10f;

    [SerializeField, Range(0f, 100f)] protected float m_maxAirAcceleration = 1f;
    ...
    [SerializeField] protected Transform m_bottomLimit;

    [SerializeField] protected Transform m_leftLimit;
